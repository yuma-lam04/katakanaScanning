...
const RAW_WORDS: WordEntry[] = [
    ...
    { word: 'ラジオ', level: 'easy' }, { word: 'ノート', level: 'easy' },
    { word: 'コップ', level: 'easy' },
    ...
    { word: 'レタス', level: 'easy' }, { word: 'ライス', level: 'easy' },
    ...
    // Long (7-10)
    { word: 'エスカレーター', level: 'easy' }, { word: 'ハンバーガー', level: 'easy' },
    { word: 'スーパーマーケット', level: 'easy' }, { word: 'コンビニエンス', level: 'easy' },
    ...
    { word: 'エラー', level: 'normal' }, { word: 'タイプ', level: 'normal' },
    ...
    // Demoted from Hard
    { word: 'ミーム', level: 'normal' }, { word: 'テーゼ', level: 'normal' },
    { word: 'カオス', level: 'normal' },
    ...
    { word: 'ビデオゲームキャラクター', level: 'easy' }, { word: 'コミュニケーションツール', level: 'easy' },
    { word: 'コンタクトレンズケース', level: 'easy' }, { word: 'ソフトウェアエンジニア', level: 'easy' },
    ...
    { word: 'ホモロジカルアルジェブラ', level: 'hard' }, { word: 'ハイヤーカテゴリーセオリー', level: 'hard' },
    ...
    { word: 'スイッチ', level: 'info' }, { word: 'ブリッジ', level: 'info' },
    ...
    { word: 'チップセット', level: 'info' }, { word: 'ペリフェラル', level: 'info' },
