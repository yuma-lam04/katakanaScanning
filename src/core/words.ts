...
// Length is determined from word.length at runtime. The ordering here is editorial only.
export const RAW_WORDS: WordEntry[] = [
    ...
    { word: 'コーヒーメーカー', level: 'easy' }, { word: 'ウォーターサーバー', level: 'easy' },
    { word: 'キッチンタイマー', level: 'easy' }, { word: 'ショッピングバッグ', level: 'easy' },
    { word: 'エスカレーター', level: 'easy' }, { word: 'ハンバーガー', level: 'easy' },
    { word: 'スーパーマーケット', level: 'easy' }, { word: 'コンビニエンス', level: 'easy' },
    { word: 'オンラインショッピング', level: 'easy' }, { word: 'デジタルカメラアクセサリー', level: 'easy' },
    ...
    { word: 'ビデオゲームキャラクター', level: 'easy' }, { word: 'コインランドリーサービス', level: 'easy' }, { word: 'コミュニケーションツール', level: 'easy' },
    { word: 'コンタクトレンズケース', level: 'easy' }, { word: 'ハイウェイサービスエリア', level: 'easy' }, { word: 'ソフトウェアエンジニア', level: 'easy' },
    ...
    { word: 'オープンソースソフトウェア', level: 'info' }, { word: 'ソフトウェアエンジニアリング', level: 'info' },
    { word: 'データベースマネジメントシステム', level: 'info' }, { word: 'コンテンツデリバリーネットワーク', level: 'info' },
    { word: 'ネットワークインタフェースカード', level: 'info' }, { word: 'ソフトウェアディファインドネットワーク', level: 'info' },
    { word: 'インシデントレスポンスプラン', level: 'info' }, { word: 'ディザスタリカバリープラン', level: 'info' },
];
